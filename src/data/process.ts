...
// Mirrors a future `process_steps` table, adjacent to `site_settings`.
export const process: ProcessStep[] = [
  ...
  },
  {
    ...
    title: "Build",
    description:
      "The product, agent or workflow gets built in fast, testable pieces, with no black-box handoffs.",
  },
  {
    id: "deliver",
    title: "Deliver",
